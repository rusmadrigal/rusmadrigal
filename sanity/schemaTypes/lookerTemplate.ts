...
export const lookerTemplate = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "url",
      description:
        "Enlace opcional a un demo o reporte de ejemplo (si publicas uno).",
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          of: [{ type: "string" }],
          description:
            'Viñetas. Ejemplo: "Reporte de páginas GSC", "Resumen de CWV"...',
        }),
        ...
        defineField({
          ...
          of: [{ type: "string" }],
          description:
            'Viñetas. Ejemplo: "Acceso a Google Search Console", "Propiedad de GA4"...',
        }),
        ...
        defineField({
          ...
          of: [{ type: "string" }],
          description:
            'Viñetas. Ejemplo: "Google Search Console", "GA4"...',
        }),
