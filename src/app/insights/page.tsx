...
export const metadata: Metadata = {
  title: "Insights sobre SEO, rendimiento y desarrollo web",
  description:
    "Insights de SEO técnico y performance web: análisis reales, mejores prácticas y aprendizajes aplicables a proyectos Next.js y sitios modernos.",
