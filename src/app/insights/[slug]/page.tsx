...
import InsightsTOC from "@/app/components/insights/InsightsTOC";
import RelatedInsights from "@/app/components/insights/RelatedInsights";

const SITE_URL = "https://www.rusmadrigal.com"; // <-- CAMBIAR
