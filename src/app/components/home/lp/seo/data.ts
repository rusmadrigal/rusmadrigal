export type Service = {
  ...
  description: string;
  bullets: string[];
  icon: "brain" | "gear" | "chart" | "puzzle" | "arrows" | "nodes" | "map";
};

export const SERVICES: Service[] = [
  {
    id: "ia-seo",
    title: "SEO preparado para IA y buscadores generativos",
    description:
      "SEO pensado para AI Overviews, motores de respuesta y modelos de lenguaje. La IA como herramienta estratégica, no como atajo.",
    bullets: [
      "Arquitectura, intención y semántica primero",
      "Optimización para buscadores y sistemas generativos",
      "Uso correcto de datos estructurados",
      "Decisiones basadas en datos, no hype",
    ],
    icon: "brain",
  },
  {
