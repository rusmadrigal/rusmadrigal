// app/home/lp/seo/ServiceBGIcon.tsx

type Props = {
  type: "gear" | "chart" | "brain" | "puzzle" | "arrows" | "nodes" | "map";
};

const posByType: Record<Props["type"], string> = {
  brain: "-right-12 -top-12 rotate-[7deg]",
  ...
  return (
    <div
      className={[
        ...
        "hidden lg:block",
        type === "brain"
          ? "h-48 w-48 opacity-[0.055] blur-[0.15px]"
          : "h-44 w-44 opacity-[0.035] blur-[0.3px]",
      ].join(" ")}
      aria-hidden="true"
    >
      <svg
        ...
        fill="none"
        stroke="currentColor"
        strokeWidth={type === "brain" ? 1.5 : 1.25}
        strokeLinecap="round"
      ...
      >
        {type === "brain" && (
          <>
            {/* Brain watermark (simple + legible) */}
            <path d="M9.5 4.5c-1.8 0-3.25 1.46-3.25 3.25v.35A3.25 3.25 0 0 0 4 11.2c0 1.6 1.16 2.95 2.7 3.2v.35c0 1.8 1.45 3.25 3.25 3.25h.55A3.25 3.25 0 0 0 13.8 20c1.6 0 2.95-1.16 3.2-2.7h.35c1.8 0 3.25-1.45 3.25-3.25v-.55A3.25 3.25 0 0 0 20 10.2c0-1.6-1.16-2.95-2.7-3.2v-.35c0-1.8-1.45-3.25-3.25-3.25h-.55A3.25 3.25 0 0 0 10.2 4.5h-.7Z" />
            <path d="M12 6v12" />
            <path d="M9 8.5c1 .2 2 .9 2 2.1" />
            <path d="M15 8.5c-1 .2-2 .9-2 2.1" />
            <path d="M9 15.5c1-.2 2-.9 2-2.1" />
            <path d="M15 15.5c-1-.2-2-.9-2-2.1" />
          </>
        )}
