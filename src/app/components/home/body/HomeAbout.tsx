      ...
      <div className="grid items-center gap-10 md:grid-cols-2">
        ...
        <div className="group relative overflow-hidden rounded-2xl bg-slate-100 shadow-sm">
          <div className="aspect-[16/10]">
            <Image
              ...
              alt="AI-Driven SEO & Web Performance"
              fill
        ...
        <div>
          ...
          <p className="mt-4 text-sm leading-6 text-slate-600">
            Trabajo en SEO desde 2009. En los últimos 15 años me he enfocado en SEO técnico, web
            performance y optimización para motores de búsqueda y agentes de IA, participando en
            proyectos de turismo, deportes, finanzas, e-commerce, automotriz y otras industrias.
          </p>
