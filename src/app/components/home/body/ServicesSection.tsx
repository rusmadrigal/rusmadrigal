      ...
      <div className="mt-12 grid gap-6 md:grid-cols-3">
        {SERVICES.map((service) => (
          <Link
            key={service.title}
            href="/seo"
            className="group block rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100 transition hover:-translate-y-1 hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/40"
          ...
          >
            ...
            <h3 className="mt-4 font-semibold tracking-tight text-slate-900">{service.title}</h3>
